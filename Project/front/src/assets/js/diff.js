...
diff_match_patch.prototype.diff_prettyHtml = function (a) {
  for (
    ...
    switch (h) {
      case DIFF_INSERT:
        b[g] = '<ins style="background:#00f566; text-decoration: none;">' + l + "</ins>";
        break;
      case DIFF_DELETE:
        b[g] = '<ins style="background:#fa5770; text-decoration: none;">' + l + "</ins>";
        break;
      case DIFF_EQUAL:
        b[g] = "<span>" + l + "</span>";
    }
...
export{
  diff_match_patch, diff_main, diff_cleanupSemantic, diff_prettyHtml
}