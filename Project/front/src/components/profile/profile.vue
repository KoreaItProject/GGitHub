    ...
    <div class="profile_container" :style="cssVariable">
        ...
        <div class="profile_bar_top_block"></div>
            ...
            <div class="profile_tab_container">
                ...
                <a id ="profile_tab1" class="profile_tab" @click="overview" >
                    <svg aria-hidden="true" height="16" viewBox="0 -2 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-book UnderlineNav-octicon hide-sm">
                    <path fill-rule="evenodd" d="M0 1.75A.75.75 0 01.75 1h4.253c1.227 0 2.317.59 3 1.501A3.744 3.744 0 0111.006 1h4.245a.75.75 0 01.75.75v10.5a.75.75 0 01-.75.75h-4.507a2.25 2.25 0 00-1.591.659l-.622.621a.75.75 0 01-1.06 0l-.622-.621A2.25 2.25 0 005.258 13H.75a.75.75 0 01-.75-.75V1.75zm8.755 3a2.25 2.25 0 012.25-2.25H14.5v9h-3.757c-.71 0-1.4.201-1.992.572l.004-7.322zm-1.504 7.324l.004-5.073-.002-2.253A2.25 2.25 0 005.003 2.5H1.5v9h3.757a3.75 3.75 0 011.994.574z"></path>
                </svg>
                    오버뷰
                </a>
                <a id ="profile_tab2" class="profile_tab" @click="repositories" >
                    <svg aria-hidden="true" height="16" viewBox="0 -2 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo UnderlineNav-octicon hide-sm">
                ...
                <a id ="profile_tab3" class="profile_tab" @click="stars"  >
                    <svg aria-hidden="true" height="16" viewBox="0 -2 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-star UnderlineNav-octicon hide-sm">
        ...
        <div class="profile_bar_left">
            ...
            <div class="profile_edit_btn_div">
              <a @click="setting"><button class="profile_edit_btn"  >내 정보 변경</button></a>
            ...
            <div class="profile_post_info_div">
              <ul class="profile_post_info_ul">
                ...
                <li class="profile_post_info_li" itemprop="homeLocation" show_title="false" aria-label="Home location: Korea">
                  ...
                  <span class="p-label">Korea</span>
                </li>
                <li class="profile_post_info_li" itemprop="email" aria-label="Email: harry7141@gmail.com" >
                  <svg class="octicon octicon-mail" viewBox="0 -1 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M1.75 2A1.75 1.75 0 000 3.75v.736a.75.75 0 000 .027v7.737C0 13.216.784 14 1.75 14h12.5A1.75 1.75 0 0016 12.25v-8.5A1.75 1.75 0 0014.25 2H1.75zM14.5 4.07v-.32a.25.25 0 00-.25-.25H1.75a.25.25 0 00-.25.25v.32L8 7.88l6.5-3.81zm-13 1.74v6.441c0 .138.112.25.25.25h12.5a.25.25 0 00.25-.25V5.809L8.38 9.397a.75.75 0 01-.76 0L1.5 5.809z"></path></svg>
                  <a class="Link--primary" href="mailto:harry7141@gmail.com">harry7141@gmail.com</a>
                </li>
              </ul>
         ...
         <div id="main_div">
            ...
            <overview v-show='isOverview'/>
            <repositories v-show='isRepositories'/>
            <stars v-show='isStars'/>
            <setting v-show='isSetting'/>
