        ...
        <div class="profile_bar_left">
            ...
            <div class="profile_folloew_div">
              <a class="" href="?tap=followers">
                <svg text="muted" aria-hidden="true" height="16" viewBox="0 -2 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-people">
