<template lang="">
    <div class="stars_container">
        <div class="stars_div" v-for="star in stars" v-bind:key="star">
            <div class="stars_repository">
                <a>koreaItProject / ggit</a>
            </div>

            <div style="float:right;">
               <button type="button" class="star_btn">
            ...
            <span class="stars_sub">3</span>
            <span class="stars_sub">Updated 7 hours ago</span>
