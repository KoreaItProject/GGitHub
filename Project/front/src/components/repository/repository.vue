  ...
  <div class="repository_container">
      <div class="repository_top_container">
          ...
          <div class="repository_tab_div" :style="cssVariable">
              ...
              <a :href="'/'+nick+'/'+repository+'?tab=pullrequest'">
                ...
                <a :href="'/'+nick+'/'+repository+'?tab=setting'">
...
methods: {
  pin_btn_click(){
    axios.post("/api/pinClick",{ // DB(pin 테이블)에 해당 저장소정보를 저장
  ...
  pin_off_btn_click(){ // 고정해제 버튼 클릭시 pin 테이블에서 해당 데이터 삭제
